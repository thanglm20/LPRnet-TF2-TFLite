...
def import_research_models():
  research_dir = path.realpath(path.join(path.dirname(__file__), '/media/thanglmb/ThangLMb/Tools/models-r1.13.0/research/'))
...
def import_transformer():
  transformer_dir = path.realpath(path.join(path.dirname(__file__), '/media/thanglmb/ThangLMb/Tools/models-r1.13.0/official/transformer'))
