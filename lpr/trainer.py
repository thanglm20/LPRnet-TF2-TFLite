...
class CTCUtils:
  ...
  def compute_ctc_from_labels(labels):
    ...
    for batch_i in range(batch_size):
      ...
      #print('labellllllllllllllllllllllllllllllllllllllll',label)
...
def encode(label_string, vocab):
  ...
  return [vocab[c] for c in re.findall('[0-9A-Z]', label_string)]
...
class LPRVocab:
  @staticmethod
  def create_vocab(train_list_path, val_list_path, use_oi_concat=False): # use_h_concat=False
    ...
    #print('========================================================',num_classes)
    #print('vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv',vocab)
  ...
  def _create_standard_vocabs(train_list_path, val_list_path):
    ...
    #chars = set.union(LPRVocab._read_specials(train_list_path)).union(LPRVocab._read_specials(val_list_path))
    chars = list(chars)
    chars.sort()
    # chars.append('-')
    # chars.append('.')
